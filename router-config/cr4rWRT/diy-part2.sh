...
# change ssid
sed -i "s/OpenWrt/cr4rWRT/g" package/kernel/mac80211/files/lib/wifi/mac80211.sh
...
echo "DISTRIB_SOURCECODE='cr4rWRT'" >>package/base-files/files/etc/openwrt_release
